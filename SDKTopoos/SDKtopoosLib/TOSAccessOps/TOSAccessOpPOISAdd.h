...
@interface TOSAccessOpPOISAdd : TOSAccessOp
/** The oauth_token. */
...
// Decimal.
/** The geocode. */
@property (nonatomic,readwrite) bool* Geocode; // (opcional)
// Decimal.
/** The accuracy. */
@property (nonatomic,readwrite) float* Accuracy; // (opcional) precisiÛn de la posiciÛn
