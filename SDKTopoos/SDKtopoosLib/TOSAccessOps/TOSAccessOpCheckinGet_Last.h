...
@interface TOSAccessOpCheckinGet_Last : TOSAccessOp
...
/** The user. */
@property (nonatomic,retain) NSString *	Usr; // (obligatorio) identificador del usuario
