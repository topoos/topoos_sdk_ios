...
#import "TOSAccessOpPOISWarning.h"

@implementation TOSAccessOpPOISWarning
...
- (bool) ValidateParams
{
    ...
    validate = validate && [self isValidorNull:Poi];
...
- (NSString *) ConcatParams
{
    ...
    if ([self ValidateParams])
    {
        ...
        params = [params stringByAppendingString: @"/pois/warnings."];
