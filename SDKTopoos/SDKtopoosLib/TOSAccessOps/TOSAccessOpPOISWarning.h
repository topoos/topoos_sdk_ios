...
@interface TOSAccessOpPOISWarning : TOSAccessOp

/** The Constant TYPE_CLOSED. */
#define TOS_ACCESS_OP_POISWARNING_TYPE_CLOSED @"CLOSED"

/** The Constant TYPE_DUPLICATED. */
#define TOS_ACCESS_OP_POISWARNING_TYPE_DUPLICATED @"DUPLICATED"

/** The Constant TYPE_WRONG_INDICATOR. */
#define TOS_ACCESS_OP_POISWARNING_TYPE_WRONG_INDICATOR @"WRONG_INDICATOR"

/** The Constant TYPE_WRONG_INFO. */
#define TOS_ACCESS_OP_POISWARNING_TYPE_WRONG_INFO @"WRONG_INFO"
 ...
 * @param type the type
 */
-(TOSAccessOpPOISWarning*) init;
-(TOSAccessOpPOISWarning*) initWithOperationName: (NSString *) operationName andMethod: (NSString *) method andFormat:(NSString *) format
