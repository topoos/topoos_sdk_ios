...
@implementation TOSAccessOpCheckinGet

@synthesize Oauth_token,Version,OperationName,Method,Format,Checkin;
...
- (bool) ValidateParams
{
    ...
    validate = validate && [self isValidInt:Checkin];
    return validate;
}
...
- (NSString *) ConcatParams
{
    ...
    if ([self ValidateParams])
    {
        ...
        params = [params stringByAppendingString: @"/checkin/get."];
        ...
        params = [params stringByAppendingString: @"&checkin="];
        params = [params stringByAppendingString:[self stringToURLEncoded: [NSString stringWithFormat:@"%d", *Checkin]]];
