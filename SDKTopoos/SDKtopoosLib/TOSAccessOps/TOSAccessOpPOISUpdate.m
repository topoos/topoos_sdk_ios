...
@implementation TOSAccessOpPOISUpdate

@synthesize Oauth_token,Lat,Lng, Geocode, Accuracy, Vaccuracy, Elevation, Categories, Name, Desc, Address, Cross_street, City, Country, Postal_code, Phone, Twitter,Poi,Version,OperationName,Method,Format;
...
-(TOSAccessOpPOISUpdate *) initWithOperationName: (NSString*) operationName andMethod: (NSString*) method andFormat:(NSString*) format andVersion: (int *) version
                               andOauth_token: (NSString*) oauth_token andPoi: (int*) poi andLat: (float*) lat andLng: (float*) lng andGeocode:(bool*) geocode andAccuracy: (float*) accuracy andVaccuracy: (float*) vaccuracy andElevation: (float*) elevation
...
- (NSString *) ConcatParams{
    ...
    if ([self ValidateParams]) {
        ...
        params = [params stringByAppendingString:[NSString stringWithFormat:@"%d",
                                                  *[self getVersion]]];
        params = [params stringByAppendingString: @"/pois/update."];
